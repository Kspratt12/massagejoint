    ...
    <section className="py-20 md:py-28 bg-ivory" id="booking">
      <div className="max-w-[1280px] mx-auto px-5 md:px-8 lg:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 max-w-3xl mx-auto mb-12">
            ...
            >
              ...
              <div className="relative">
                ...
                <h3 className="font-serif text-xl md:text-2xl text-ivory mb-2">New Client</h3>
                <p className="text-ivory/60 text-sm font-light">
                  First time visiting? Welcome. Start here.
                </p>
              </div>
            </a>
            ...
            >
              ...
              <div className="relative">
                <div className="w-14 h-14 mx-auto mb-5 rounded-full bg-champagne/20 flex items-center justify-center">
                  <svg className="w-6 h-6 text-champagne-light" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z" />
                  </svg>
                </div>
                <h3 className="font-serif text-xl md:text-2xl text-ivory mb-2">Returning Client</h3>
                <p className="text-ivory/60 text-sm font-light">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
            {[
              ...
              >
                ...
                <span className="text-sm text-charcoal font-light tracking-wide">
                  {item.label}
                </span>
              </a>
            ))}
        ...
        <AnimatedSection delay={0.3}>
          <p className="text-center text-charcoal/50 text-sm font-light mt-8 max-w-lg mx-auto">
            Need to schedule both massage and skincare in one visit?
            Call or text <a href={`tel:${contactInfo.phoneRaw}`} className="text-sage hover:text-sage-dark underline underline-offset-2">{contactInfo.phone}</a> to book dual appointments.
          </p>
        </AnimatedSection>
      </div>
    </section>
