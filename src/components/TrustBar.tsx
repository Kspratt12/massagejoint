...
const trustSignals = [
  ...
  },
  {
    ...
    label: "Downtown Apex, NC",
  },
];

export default function TrustBar() {
  return (
    <section className="bg-charcoal/95 py-5">
      <AnimatedSection>
          ...
          <div className="flex flex-wrap items-center justify-center gap-x-10 gap-y-3">
            {trustSignals.map((signal, i) => (
              ...
              >
                ...
                <span className="text-[11px] md:text-xs font-light tracking-[0.03em] whitespace-nowrap">
                  {signal.label}
                </span>
              </div>
            ))}
